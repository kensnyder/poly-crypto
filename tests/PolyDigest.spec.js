...
describe('PolyDigest', () => {
	...
	it('should run sha1 properly', () => {
		...
		expect(digest).to.equal('f182cb6b0fa5df0150bc9ce4a88769c66fc6cdeb');
	});
	it('should run sha256 properly', () => {
		const digest = PolyDigest.sha256('digest me');
		expect(digest).to.equal('a230eb9c90aa2a2e9cc1286fd505a348beae8cb74730255608db9284e2f7cef5');
	});
