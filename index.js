...
var PolyAES = /*#__PURE__*/function () {
  _createClass(PolyAES, null, [{
    ...
    value: function withPassword(password, salt) {
      var numIterations = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10000;
  ...
  _createClass(PolyAES, [{
    ...
    value: function _binToUtf8(data) {
      if (typeof Buffer !== 'undefined') {
        ...
        var escstr = data.replace(/./g, function (_char) {
          var code = _char.charCodeAt(0).toString(16).toUpperCase();
    ...
    value: function generateKey() {
      ...
      return _nodeForge["default"].util.bytesToHex(_nodeForge["default"].random.getBytesSync(length / 2));
    }
    /**
